...
@Entity
@Table(name = "inventory_output_movements")
public final class InventoryOutputMovementEntity {
    ...
    public static InventoryOutputMovementEntity create(Long id, Long inventoryId, Integer quantity, String outputReason, String rejectReason) {
        InventoryOutputMovementEntity entity = new InventoryOutputMovementEntity();

        entity.setId(id);
        entity.setInventoryId(inventoryId);
        entity.setQuantity(quantity);
        entity.setOutputReason(outputReason);
